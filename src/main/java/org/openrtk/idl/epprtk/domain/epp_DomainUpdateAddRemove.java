 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/domain/epp_DomainUpdateAddRemove.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:50 $<br>
 * @see org.openrtk.idl.epprtk.domain.epp_DomainUpdateReq#setAdd(epp_DomainUpdateAddRemove)
 * @see org.openrtk.idl.epprtk.domain.epp_DomainUpdateReq#setRemove(epp_DomainUpdateAddRemove)
 */
public class epp_DomainUpdateAddRemove implements org.omg.CORBA.portable.IDLEntity
{
   ...
   */
  public epp_DomainUpdateAddRemove (String[] _m_name_servers, org.openrtk.idl.epprtk.domain.epp_DomainContact[] _m_contacts, org.openrtk.idl.epprtk.domain.epp_DomainStatus[] _m_status)
  {

...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epprtk/rtk/xml/EPPXMLBase.java,v 1.2 2007/05/18 14:58:41 asimbirt Exp $
 * $Revision: 1.2 $
 * $Date: 2007/05/18 14:58:41 $
 */
 ...
 * @version $Revision: 1.2 $ $Date: 2007/05/18 14:58:41 $
**/
public abstract class EPPXMLBase extends RTKBase
{
     ...
     * @throws org.openrtk.idl.epprtk.epp_XMLException if the node list does not contain the result text
     */
     ...
     * @throws org.openrtk.idl.epprtk.epp_XMLException if the node list does not contain the data
     */

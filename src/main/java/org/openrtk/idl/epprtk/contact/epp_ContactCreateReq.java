 ...
 * in the registry.</p>
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactCreateReq.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:49 $<br>
 * @see com.tucows.oxrs.epprtk.rtk.xml.EPPContactCreate
 * @see org.openrtk.idl.epprtk.contact.epp_ContactCreateRsp
 */
public class epp_ContactCreateReq implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #m_addresses
   */
  public epp_ContactCreateReq (org.openrtk.idl.epprtk.epp_Command _m_cmd, String _m_id, org.openrtk.idl.epprtk.contact.epp_ContactNameAddress[] _m_addresses, org.openrtk.idl.epprtk.contact.epp_ContactPhone _m_voice, org.openrtk.idl.epprtk.contact.epp_ContactPhone _m_fax, String _m_email, org.openrtk.idl.epprtk.epp_AuthInfo _m_auth_info)
  {
    m_cmd = _m_cmd;
    m_id = _m_id;

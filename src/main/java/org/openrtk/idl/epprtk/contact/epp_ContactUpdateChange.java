 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactUpdateChange.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:49 $<br>
 * @see org.openrtk.idl.epprtk.contact.epp_ContactUpdateReq#setChange(epp_ContactUpdateChange)
 */
public class epp_ContactUpdateChange implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @deprecated
   */
  public epp_ContactUpdateChange (org.openrtk.idl.epprtk.contact.epp_ContactNameAddress _m_ascii_address, org.openrtk.idl.epprtk.contact.epp_ContactNameAddress _m_i15d_address, org.openrtk.idl.epprtk.contact.epp_ContactPhone _m_voice, org.openrtk.idl.epprtk.contact.epp_ContactPhone _m_fax, String _m_email, org.openrtk.idl.epprtk.epp_AuthInfo _m_auth_info)
  {
   ...
   * @param _m_auth_info The authorization information to be associated with the contact object
   */
  public epp_ContactUpdateChange (org.openrtk.idl.epprtk.contact.epp_ContactNameAddress[] _m_addresses, org.openrtk.idl.epprtk.contact.epp_ContactPhone _m_voice, org.openrtk.idl.epprtk.contact.epp_ContactPhone _m_fax, String _m_email, org.openrtk.idl.epprtk.epp_AuthInfo _m_auth_info)
  {
  ...
  public String toString() {
    if ( m_ascii_address == null )
      return this.getClass().getName() + ": { m_ascii_address ["+m_ascii_address+"] m_i15d_address ["+m_i15d_address+"] m_voice ["+m_voice+"] m_fax ["+m_fax+"] m_email ["+m_email+"] m_auth_info ["+m_auth_info+"] }";
    else
      return this.getClass().getName() + ": { m_addresses ["+(m_addresses != null ? java.util.Arrays.asList(m_addresses) : null)+"] m_voice ["+m_voice+"] m_fax ["+m_fax+"] m_email ["+m_email+"] m_auth_info ["+m_auth_info+"] }";
  }

 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/contact/epp_ContactInfoRsp.java,v 1.1 2004/12/07 15:27:49 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
 * $Date: 2004/12/07 15:27:49 $<br>
 * @see com.tucows.oxrs.epprtk.rtk.xml.EPPContactInfo
 * @see org.openrtk.idl.epprtk.contact.epp_ContactInfoReq
 */
public class epp_ContactInfoRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setAddresses(org.openrtk.idl.epprtk.contact.epp_ContactNameAddress[])
   * @see #getAddresses()
   * @deprecated
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactNameAddress m_ascii_address = null;
  /**
   * The contact name and address associated with the contact object.
   ...
   * @deprecated
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactNameAddress m_i15d_address = null;
  /**
   * The contact names and addresses associated with the contact object.
   * EPP permits up to two addresses to be specified.  The first is always
   * internationalized and represented in a subset of UTF-8 limited to
   * 7-bit US-ASCII.  The optional second address may be represented in 
   * unrestricted UTF-8.
   * @see #setAddresses(org.openrtk.idl.epprtk.contact.epp_ContactNameAddress[])
   * @see #getAddresses()
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactNameAddress m_addresses[] = null;
  /**
   * The contact's telephone number.
   * @see #setVoice(org.openrtk.idl.epprtk.contact.epp_ContactPhone)
   * @see #getVoice()
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactPhone m_voice = null;
  /**
   * The contact's fax number.
   * @see #setFax(org.openrtk.idl.epprtk.contact.epp_ContactPhone)
   * @see #getFax()
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactPhone m_fax = null;
  /**
   ...
   * @deprecated
   */
  public epp_ContactInfoRsp (org.openrtk.idl.epprtk.epp_Response _m_rsp, String _m_id, String _m_roid, org.openrtk.idl.epprtk.contact.epp_ContactNameAddress _m_ascii_address, org.openrtk.idl.epprtk.contact.epp_ContactNameAddress _m_i15d_address, org.openrtk.idl.epprtk.contact.epp_ContactPhone _m_voice, org.openrtk.idl.epprtk.contact.epp_ContactPhone _m_fax, String _m_email, org.openrtk.idl.epprtk.contact.epp_ContactStatus[] _m_status, String _m_client_id, String _m_created_by, String _m_created_date, String _m_updated_by, String _m_updated_date, String _m_transfer_date, org.openrtk.idl.epprtk.epp_AuthInfo _m_auth_info)
  {
    m_rsp = _m_rsp;
    m_id = _m_id;
    m_roid = _m_roid;
   ...
   * @param _m_id The identifier for the contact object in the registry
   * @param _m_roid The repository object identifier associated with the domain object
   * @param _m_addresses The contact names and addresses associated with the contact object
   * @param _m_voice The contact's telephone number
   * @param _m_fax The contact's fax number
   * @param _m_email The contact's e-mail address
   * @param _m_status The array of status associated with the contact object
   ...
   * @param _m_auth_info The authorization information associated with the contact object
   */
  public epp_ContactInfoRsp (org.openrtk.idl.epprtk.epp_Response _m_rsp, String _m_id, String _m_roid, org.openrtk.idl.epprtk.contact.epp_ContactNameAddress[] _m_addresses, org.openrtk.idl.epprtk.contact.epp_ContactPhone _m_voice, org.openrtk.idl.epprtk.contact.epp_ContactPhone _m_fax, String _m_email, org.openrtk.idl.epprtk.contact.epp_ContactStatus[] _m_status, String _m_client_id, String _m_created_by, String _m_created_date, String _m_updated_by, String _m_updated_date, String _m_transfer_date, org.openrtk.idl.epprtk.epp_AuthInfo _m_auth_info)
  {
    m_rsp = _m_rsp;
    m_id = _m_id;
    m_roid = _m_roid;
   ...
   * @deprecated
   */
  public void setAsciiAddress(org.openrtk.idl.epprtk.contact.epp_ContactNameAddress value) { m_ascii_address = value; }
  /**
   * Accessor method for the ascii contact name and address associated with the contact object
   ...
   * @deprecated
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactNameAddress getAsciiAddress() { return m_ascii_address; }
   ...
   * @deprecated
   */
  public void setI15dAddress(org.openrtk.idl.epprtk.contact.epp_ContactNameAddress value) { m_i15d_address = value; }
  /**
   * Accessor method for the i15d contact name and address associated with the contact object
   ...
   * @deprecated
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactNameAddress getI15dAddress() { return m_i15d_address; }

  /**
   * Accessor method for the contact names and addresses associated with the contact object
   * @param value The contact names and addresses
   * @see #m_addresses
   */
  public void setAddresses(org.openrtk.idl.epprtk.contact.epp_ContactNameAddress[] value) { m_addresses = value; }
  /**
   * Accessor method for the contact names and addresses associated with the contact object
   * @return The contact names and addresses
   * @see #m_addresses
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactNameAddress[] getAddresses() { return m_addresses; }
   ...
   * @see #m_voice
   */
  public void setVoice(org.openrtk.idl.epprtk.contact.epp_ContactPhone value) { m_voice = value; }
  /**
   * Accessor method for the contact's telephone number
   * @return The contact's telephone number
   * @see #m_voice
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactPhone getVoice() { return m_voice; }
   ...
   * @see #m_fax
   */
  public void setFax(org.openrtk.idl.epprtk.contact.epp_ContactPhone value) { m_fax = value; }
  /**
   * Accessor method for the contact's fax number
   * @param value The contact's fax number
   * @see #m_fax
  ...
  public void setFax(String value) { m_fax = new org.openrtk.idl.epprtk.contact.epp_ContactPhone("",value); }
  /**
   * Accessor method for the contact's fax number
   * @return The contact's fax number
   * @see #m_fax
   */
  public org.openrtk.idl.epprtk.contact.epp_ContactPhone getFax() { return m_fax; }

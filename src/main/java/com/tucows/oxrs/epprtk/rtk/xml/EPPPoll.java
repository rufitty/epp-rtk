...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epprtk/rtk/xml/EPPPoll.java,v 1.1 2004/12/07 15:53:27 ewang2004 Exp $
 * $Revision: 1.1 $
...
import com.tucows.oxrs.epprtk.rtk.xml.poll.*;
...
public class EPPPoll extends EPPXMLBase implements epp_Poll
{
     ...
     * look in the com.tucows.oxrs.epprtk.rtk.xml.poll package for
     ...
     * "com.tucows.oxrs.epprtk.rtk.xml.poll".  It turns out that this class
     ...
     * @see com.tucows.oxrs.epprtk.rtk.RTKBase#getRTKProperties()
     */

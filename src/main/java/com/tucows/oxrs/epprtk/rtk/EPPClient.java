...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epprtk/rtk/EPPClient.java,v 1.1 2004/12/07 15:53:26 ewang2004 Exp $
 * $Revision: 1.1 $
...
import com.tucows.oxrs.epprtk.rtk.transport.*;
...
public class EPPClient extends RTKBase implements epp_Session
{
     ...
     * @param services The service URI array
     */
    public void setEPPServices(String[] services) { epp_services_ = services; }

    /**
     * Accessor method for the epp services.
     * @return The current services in an array.
     */
    public String[] getEPPServices() { return epp_services_; }

    /**
     * Accessor method for the epp service extensions
     * @param service_extensions The service extension array
     */
    public void setEPPServiceExtensions(String[] service_extensions) { epp_service_extensions_ = service_extensions; }

    /**
     * Accessor method for the epp service extensions.
     * @return The current service extensions in an array.
     */
    public String[] getEPPServiceExtensions() { return epp_service_extensions_; }
	...
	if ( transport_ != null )
        ...
        try { java.security.Security.addProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider()); } catch(Exception xcp) { throw new IOException(xcp.getMessage()); }
     ...
     * @throws org.openrtk.idl.epprtk.epp_Exception if there was a socket error in reading from the EPP Server
     */
     ...
     * @throws org.openrtk.idl.epprtk.epp_Exception if a communication error occurs
     */
     ...
     * @throws org.openrtk.idl.epprtk.epp_XMLException if any request data or response data is missing
     * @throws org.openrtk.idl.epprtk.epp_Exception if a communication error occurs or if the server returns an error code
     ...
     * @throws org.openrtk.idl.epprtk.epp_Exception if the server greeting is not present
     * @throws org.openrtk.idl.epprtk.epp_XMLException if the server's greeting is not parsable
     * @throws com.tucows.oxrs.epprtk.rtk.transport.EPPTransportException if there are problems initializing the transport
     * @see #connect()
     * @see #getGreeting()
     */
     ...
     * @throws org.openrtk.idl.epprtk.epp_XMLException if the request XML could not be built or if the response XML could not be parsed.
     * @throws org.openrtk.idl.epprtk.epp_Exception if the EPP Server responded with an error code
     */
    ...
    public void login(String client_tr_id, String new_password) throws epp_XMLException, epp_Exception
    {
        ...
        epp_LoginReq login_req = new epp_LoginReq( command_data,
                                                   epp_client_id_,
                                                   epp_password_,
                                                   new_password,
                                                   new epp_Options(version_, lang_),
                                                   null,
                                                   null );
     ...
     *
     * @param send If true, RTK version number will be send in svcExtension section on
     *      Login
     */

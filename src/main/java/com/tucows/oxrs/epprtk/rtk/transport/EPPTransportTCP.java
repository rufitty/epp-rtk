...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epprtk/rtk/transport/EPPTransportTCP.java,v 1.1 2004/12/07 15:53:27 ewang2004 Exp $
 * $Revision: 1.1 $
...
public class EPPTransportTCP extends EPPTransportBase 
{
     ...
     * @throws org.openrtk.idl.epprtk.epp_Exception if there was a socket error in 
     *         reading from the EPP Server
     * @see org.openrtk.idl.epprtk.epp_Session#RTK_COMMUNICATIONS_FAILURE
     * @see org.openrtk.idl.epprtk.epp_Session#RTK_UNEXPECTED_SERVER_DISCONNECT
     */

...
/*
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/com/tucows/oxrs/epprtk/rtk/xml/EPPDomainUpdate.java,v 1.1 2004/12/07 15:53:27 ewang2004 Exp $
 * $Revision: 1.1 $
 ...
 * @see org.openrtk.idl.epprtk.domain.epp_DomainUpdate
...
public class EPPDomainUpdate extends EPPDomainBase implements epp_DomainUpdate
{
     ...
     * @param value org.openrtk.idl.epprtk.epp_DomainUpdateReq
     */
     ...
     * @return value org.openrtk.idl.epprtk.epp_DomainUpdateRsp
     */
    ...
    public String toXML() throws epp_XMLException
    {
        ...
        if ( action_request_.m_change != null )
        {
            ...
            {
                change_element.appendChild( prepareAuthInfo( doc, "domain", action_request_.m_change.m_auth_info ) );
            }
        ...
        if ( add_remove_items != null )
        {
                 ...
                 add_remove_items.m_contacts.length > 0 )
            {
                ...
                for (Iterator it = contact_list.iterator(); it.hasNext();)
                {
                    ...
                    Element contact_element = addXMLElement(doc, add_remove_element, "domain:contact", domain_contact.m_id);

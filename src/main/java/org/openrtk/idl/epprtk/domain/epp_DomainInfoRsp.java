 ...
 * $Header: /cvsroot/epp-rtk/epp-rtk/java/src/org/openrtk/idl/epprtk/domain/epp_DomainInfoRsp.java,v 1.1 2004/12/07 15:27:50 ewang2004 Exp $<br>
 * $Revision: 1.1 $<br>
...
public class epp_DomainInfoRsp implements org.omg.CORBA.portable.IDLEntity
{
   ...
   * @see #setStatus(org.openrtk.idl.epprtk.domain.epp_DomainStatus[])
   * @see #getStatus()
   */
  public org.openrtk.idl.epprtk.domain.epp_DomainStatus m_status[] = null;
  /**
   ...
   */
  public epp_DomainInfoRsp (org.openrtk.idl.epprtk.epp_Response _m_rsp, String _m_name, String _m_roid, org.openrtk.idl.epprtk.domain.epp_DomainStatus[] _m_status, String _m_registrant, org.openrtk.idl.epprtk.domain.epp_DomainContact[] _m_contacts, String[] _m_name_servers, String[] _m_hosts, String _m_client_id, String _m_created_by, String _m_created_date, String _m_updated_by, String _m_updated_date, String _m_expiration_date, String _m_transfer_date, org.openrtk.idl.epprtk.epp_AuthInfo _m_auth_info)
  {
    m_rsp = _m_rsp;
    m_name = _m_name;
    m_roid = _m_roid;
   ...
   * @see #m_status
   */
  public void setStatus(org.openrtk.idl.epprtk.domain.epp_DomainStatus[] value) { m_status = value; }
  /**
   * Accessor method for the array of status associated with the domain object
   * @return The array of domain status
   * @see #m_status
   */
  public org.openrtk.idl.epprtk.domain.epp_DomainStatus[] getStatus() { return m_status; }
